...
const statusColor = { PENDING:'badge-warning',CONFIRMED:'badge-info',SHIPPED:'badge-info',DELIVERED:'badge-success',CANCELLED:'badge-danger' };
  ...
  return (
    <div>
      ...
      <div className="card table-wrap">
        <table>
          <thead>
            <tr><th>ID</th><th>User</th><th>Amount</th><th>Status</th><th>Date</th><th>Update Status</th></tr>
          </thead>
          <tbody>
            {orders.map(o => (
              <tr key={o.id}>
                ...
                <td>
                  <select style={{ padding:'4px 8px', borderRadius:6, border:'1px solid var(--border)' }}
